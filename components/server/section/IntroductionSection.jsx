      ...
      <div className={styles.content}>
        ...
        <div className={styles.third}>
          <p className={styles.description}>
            I have always been a fast learner and new emerging technologies have
            always intrigued me. I have the mindset of an engineer and I have a
            strong analytical side.
          </p>
        </div>
        <div className={styles.fourth}>
          <LinkButtonPrimary href="/">Check out my Github!</LinkButtonPrimary>
        </div>
      </div>
    </section>
  );
